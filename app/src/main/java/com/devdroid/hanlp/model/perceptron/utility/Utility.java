 ...
 * </copyright>
 */
package com.devdroid.hanlp.model.perceptron.utility;

import com.devdroid.hanlp.corpus.io.IOUtil;
import com.devdroid.hanlp.dictionary.other.CharTable;
import com.devdroid.hanlp.model.perceptron.PerceptronSegmenter;
import com.devdroid.hanlp.corpus.document.CorpusLoader;
import com.devdroid.hanlp.corpus.document.Document;
import com.devdroid.hanlp.corpus.document.sentence.Sentence;
import com.devdroid.hanlp.corpus.document.sentence.word.CompoundWord;
import com.devdroid.hanlp.corpus.document.sentence.word.IWord;
import com.devdroid.hanlp.corpus.document.sentence.word.Word;
...
import com.devdroid.hanlp.tokenizer.lexical.NERecognizer;
    ...
    public static int[] evaluateCWS(String developFile, final PerceptronSegmenter segmenter) throws IOException
    {
        ...
        IOUtility.loadInstance(developFile, new InstanceHandler()
        {
            ...
            public boolean process(Sentence sentence)
            {
                ...
                String text = com.devdroid.hanlp.utility.TextUtility.combine(wordArray);
