 ...
 * </copyright>
 */
package com.devdroid.hanlp.model.crf;

import com.devdroid.hanlp.HanLP;
import com.devdroid.hanlp.corpus.io.ByteArray;
import com.devdroid.hanlp.corpus.io.FileIOAdapter;
...
import com.devdroid.hanlp.model.perceptron.tagset.CWSTagSet;
...
import static com.devdroid.hanlp.utility.Predefine.BIN_EXT;
...
public class LogLinearModel extends LinearModel
{
    ...
    public LogLinearModel(String modelFile) throws IOException
    {
        ...
        if (!((HanLP.IOAdapter == null || HanLP.IOAdapter instanceof FileIOAdapter) && !IOUtil.isFileExisted(binPath)))
        {
            try
            {
