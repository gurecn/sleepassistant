...
import com.devdroid.hanlp.corpus.occurrence.TermFrequency;
...
public class TFDictionary extends SimpleDictionary<TermFrequency> implements ISaveAble
{
    ...
    /**
     * 合并多个词典
     * @param path 多个词典的路径，第一个是主词典。主词典与其他词典的区别详见com.hankcs.hanlp.corpus.dictionary.TFDictionary#combine(com.devdroid.hanlp.corpus.dictionary.TFDictionary, int, boolean)
     * @return 词条的增量
     */
