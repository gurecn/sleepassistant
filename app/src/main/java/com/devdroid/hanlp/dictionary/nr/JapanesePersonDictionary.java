 ...
 * </copyright>
 */
package com.devdroid.hanlp.dictionary.nr;
...
import com.devdroid.hanlp.dictionary.BaseSearcher;
...
{
    static String path = HanLP.JapanesePersonDictionaryPath;
    ...
    static
    {
        ...
        logger.info("日本人名词典" + HanLP.PinyinDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
    }
