...
import com.devdroid.sleepassistant.speech.local.engine.BaseSpeechRecognitionEngine;
import com.devdroid.sleepassistant.speech.local.engine.DummyOnInitListener;
import com.devdroid.sleepassistant.speech.local.engine.SpeechRecognitionEngine;
import com.devdroid.sleepassistant.speech.local.engine.BaseTextToSpeechEngine;
import com.devdroid.sleepassistant.speech.local.engine.TextToSpeechEngine;
import com.devdroid.sleepassistant.speech.local.ui.SpeechProgressView;
...
public class Speech {
    ...
    private void SpeechInit(final Context context, final String callingPackage, TextToSpeech.OnInitListener onInitListener, SpeechRecognitionEngine speechRecognitionEngine, TextToSpeechEngine textToSpeechEngine) {
        mContext = context;
     ...
     */
    public Speech init(final Context context, final String callingPackage) {
        if (instance != null) {
            instance.SpeechInit(context, callingPackage, new DummyOnInitListener(), new BaseSpeechRecognitionEngine(), new BaseTextToSpeechEngine());
        }
        return instance;
    }

    public Speech init(final Context context, final String callingPackage, TextToSpeech.OnInitListener onInitListener) {
        if (instance != null) {
            ...
            instance.SpeechInit(context, callingPackage, initListener, new BaseSpeechRecognitionEngine(), new BaseTextToSpeechEngine());
        }
        return instance;
    }
    ...
    public boolean isSpeaking() {
        if(instance == null || !isInitSuccess) return false;
