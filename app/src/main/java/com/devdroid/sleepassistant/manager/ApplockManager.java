...
//
//import com.devdroid.miwo.applockdemo.com.devdroid.miwo.applockdemo.database.BaseDataProvider;
//import com.devdroid.miwo.applockdemo.com.devdroid.miwo.applockdemo.database.LockerDao;
...
//        BaseDataProvider dataProvider = new BaseDataProvider(MyApplication.getAppContext());
//        mLockerDao = new LockerDao(MyApplication.getAppContext(), dataProvider);
//        componentNames = mLockerDao.queryLockerInfo();
//        PreferencesManager mDefaultPM = PreferencesManager.getDefaultSharedPreference(MyApplication.getAppContext());
